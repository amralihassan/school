    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('department.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    @include('layouts.includes._msg')
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" id="userinput1" class="form-control border-primary" value="{{old('arabicDepartment')}}" placeholder="{{ trans('staff::admin.arabic_department') }}"
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text"  class="form-control border-primary" value="{{old('englishDepartment')}}" placeholder="{{ trans('staff::admin.english_department') }}"
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="number" min="1" max="100"  class="form-control border-primary" value="{{old('balanceDepartmentLeave')}}" placeholder="{{ trans('staff::admin.sort') }}"
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="number" min="1" max="100"  class="form-control border-primary" value="{{old('sort')}}" placeholder="{{ trans('staff::admin.sort') }}"
                            name="sort" >
                          </div>
                        </div>
                      </div>
...
@section('script')
<script>
    	    (function getSectorsNamesWithNull()
	    {
	        $.ajax({
	          type:'ajax',
	          method:'get',
	          url:'{{route("getSectorsWithNull")}}',
	          dataType:'json',
