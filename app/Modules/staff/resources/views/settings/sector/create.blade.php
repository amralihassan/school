    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('sector.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" id="userinput1" class="form-control border-primary" value="{{old('arabicSector')}}" placeholder="{{ trans('staff::admin.arabic_sector') }}"
                              name="arabicSector" ">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text"  class="form-control border-primary" value="{{old('englishSector')}}" placeholder="{{ trans('staff::admin.english_sector') }}"
                            name="englishSector" >
                          </div>
                        </div>
                      </div>
